   ...
   <>
    <header id="hero" className="hero-section text-white text-center">
             ...
             <section id="features" className="py-5">
              ...
              Quickly create professional invoices by filling simple and intuitive forms. Add client details, items, pricing, and taxes without any confusion. Designed to save time and reduce manual errors.
                                        </p>
                                ...
                                <div className="row align-items-center gy-4 mt-5 flex-row-reverse"> 
                                    ...
                                    <div className="col-md-6">
                                        ...
                                        <p className="text-muted lead fs-6 mx-2">
                                            Manage all your invoices in one place with a clean and user-friendly dashboard. Easily track, view, and organize your invoices with smart previews and quick access features.
                                        </p>
                                        <ul className="list-unstyled text-muted">
                                ...
                                <div className="row align-items-center gy-4 mt-5">
                                    ...
                                    <div className="col-md-6">
                                        ...
                                        <p className="text-muted lead fs-6 mx-2">
                                             Get a real-time preview of your invoice before finalizing. Make quick edits and perform actions like save, download, or delete instantly with just one click.
                                        </p>
                                        <ul className="list-unstyled text-muted">
                                ...
                                <div className="row align-items-center gy-4 mt-5 flex-row-reverse"> 
                                    ...
                                    <div className="col-md-6">
                                        ...
                                        <p className="text-muted lead fs-6 mx-2">
                                           Share invoices directly with your clients in seconds. No need for external tools—send professional invoices instantly and improve your workflow efficiency.
                                        </p>
                                        <ul className="list-unstyled text-muted">
